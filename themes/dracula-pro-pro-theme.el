...
(let ((colors '(;; Upstream theme color
                ...
                (dracula-pro-pro-pink2    "#88338b" "#88338b" "darkmagenta")
                ...
                (dracula-pro-pro-bg4      "#56557A" "#56557A" "brightblack")
                ...
                (dracula-pro-pro-alt-blue2 "#564280" "#564280" "darkblue")))
      (faces '(;; default
               (cursor :foreground ,dracula-pro-pro-pink2 :background ,dracula-pro-pro-fg3)
               ...
               ;; diff-hl
               (diff-hl-change :background ,dracula-pro-pro-orange)
               (diff-hl-delete :background ,dracula-pro-pro-pink2)
               (diff-hl-insert :background ,dracula-pro-pro-alt-blue2)
               ;; ediff
               (ediff-current-diff-A :background ,dracula-pro-pro-pink2)
               (ediff-current-diff-B :background ,dracula-pro-pro-alt-blue2)
               ;; dired
               ...
               (helm-selection :background ,dracula-pro-pro-current :underline nil) ; change from bg color to current color because bg color is too dark to read
               (helm-selection-line :background ,dracula-pro-pro-current :undrline nil :box t) ; this is the preview buffer when doing selection, use box to highlight it
               ...
               (magit-diff-added :background ,dracula-pro-pro-alt-blue2
                                 :extend t)
               (magit-diff-added-highlight :background ,dracula-pro-pro-alt-blue2
                                           :extend t)
               (magit-diff-removed :background ,dracula-pro-pro-pink2
                                   :extend t)
               (magit-diff-removed-highlight :background ,dracula-pro-pro-pink2
                                             :extend t)
               (magit-diff-file-heading :foreground ,dracula-pro-pro-fg)
               (magit-diff-file-heading-highlight :inherit magit-section-highlight)
               (magit-diffstat-added :foreground ,dracula-pro-pro-alt-blue2)
               (magit-diffstat-removed :foreground ,dracula-pro-pro-pink2)
